...
function Igraphic()
{
	...
	switch (n){
		case 1:data1.push([90-angle,Ia]);break;
		case 2:data2.push([90-angle,Ia]);break;
		case 3:data3.push([90-angle,Ia]);
	}
...
function getAnswer( ntext){
	...
	var U_2 = Math.sqrt(U);
	switch(ntext){
	case 2:a =String(round_double(0.590*U_2));break;
	case 3:a =String(round_double(1.225/U_2));break;
	case 4:	   
