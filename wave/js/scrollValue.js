...
var nValue; // для отладки
	switch (a){
		case 2:if(imXSc<widthSc-56)imXSc+=5;nValue =Math.round(50+0.5*(imXSc-imX0Sc));change_U(nValue);break;
		case 1:if(imXSc>imX0Sc)imXSc-=5;nValue =Math.round(50+0.5*(imXSc-imX0Sc));change_U(nValue);break;
	}
//	if(a==1)imX++;
	paintSc();
}
